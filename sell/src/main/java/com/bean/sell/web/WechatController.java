...
public class WechatController {
    ...
    public String authorize(@RequestParam("returnUrl") String returnUrl){
        ...
        String url = "http://teuc6i.natappfree.cc/sell/wechat/userInfo";
        ...
        log.info("【微信网页授权获取code-{}】",redirecUrl);
        return "redirect:" + redirecUrl;
    }

    @GetMapping("/userInfo")
    public String getUerInfo(@RequestParam("code") String code,
        ...
        try{
            ...
            log.error("微信网页授权");
            throw new SellException(77,"auth");
        }
